...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/04/29 17:15:56 by side-lan          #+#    #+#             */
/*   Updated: 2026/04/29 17:34:09 by side-lan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_check_builtins(t_exec_info *exec_info, t_data *data, \
char **arguments);
...
int		ft_single_redirection(t_token *curr, int *fd_in, \
int *fd_out, t_data *data);
void	ft_builtin_fds(t_single_fds fds, int words, \
