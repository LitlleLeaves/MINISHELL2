...
/*   Updated: 2026/04/24 12:48:03 by jjhurry          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_builtin_fds(t_single_fds fds, int words, char **args, t_data *data)
{
	if (fds.fd_in >= 0)
	{
	...
	ft_execute_single_builtin(words, args, data);
	if (fds.std_in >= 0)
	{
